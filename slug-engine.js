...
// PIRAMIDE GEOMETRY
class PyramideGeometry extends Geometry {
    constructor(size) {
        super();

        this.vertices = [
             0.0, size, 0.0,  -size, -size,  size,   size, -size,  size, // Front face
             0.0, size, 0.0,   size, -size,  size,   size, -size, -size, // Right face
             0.0, size, 0.0,   size, -size, -size,  -size, -size, -size, // Back face
             0.0, size, 0.0,  -size, -size, -size,  -size, -size,  size  // Left face
        ];
...
class PerspectiveCamera {
    ...
    move(distance, x, y, z) {
        ...
        console.log(this.position.elements);
